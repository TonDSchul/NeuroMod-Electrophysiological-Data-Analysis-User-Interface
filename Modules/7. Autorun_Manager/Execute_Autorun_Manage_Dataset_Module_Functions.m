...
if strcmp(FunctionOrder,'Load_Data')
    ...
    if strcmp(AutorunConfig.ExtractMultipleRecordings,"on")
        ...
        if strcmp(AutorunConfig.ExtractRawRecording.RecordingsSystem,"Intan") || strcmp(AutorunConfig.ExtractRawRecording.RecordingsSystem,"Neuralynx")
...
if strcmp(FunctionOrder,'Save_Data')
    ...
    if Execute == 1
        if strcmp(AutorunConfig.ExtractMultipleRecordings,"on")
            ...
            if strcmp(AutorunConfig.ExtractRawRecording.RecordingsSystem,"Intan") || strcmp(Data.Info.RecordingType,"Neuralynx")
