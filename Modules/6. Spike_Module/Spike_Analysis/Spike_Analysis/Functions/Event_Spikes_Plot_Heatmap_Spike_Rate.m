...
%% makse sure that Image_handles is empty
...
if ~isempty(Image_handles)
    ...
    if strcmp(TwoORThreeD,"TwoD")
        ...
        'CData', spike_rates, 'FaceColor', 'texturemap', 'EdgeColor', 'none');
    ...
    elseif strcmp(TwoORThreeD,"ThreeD")
        % 3D
        surf(Figure,time_edges(1:end-1),DepthToPlot,spike_rates, 'Tag', 'SpikeRateImage','EdgeColor', 'none')
        % 2D
        % 2D Plot
