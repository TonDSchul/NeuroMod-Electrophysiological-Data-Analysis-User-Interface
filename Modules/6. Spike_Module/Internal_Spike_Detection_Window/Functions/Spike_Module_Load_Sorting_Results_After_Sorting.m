function Spike_Module_Load_Sorting_Results_After_Sorting(app,Sorter)

if ~strcmp(Sorter,"WaveClus 3")
    if strcmp(Sorter,"Kilosort 4")
        SoterFolders(1) = strcat(app.Mainapp.Data.Info.Data_Path,"\Kilosort\kilosort4");
        SoterFolders(2) = "";
        SoterFolders(3) = "";
        SoterFolders(4) = "";
    elseif strcmp(Sorter,"Mountainsort 5")
        SoterFolders(1) = "";
        SoterFolders(2) = "";
        SoterFolders(3) = strcat(app.Mainapp.Data.Info.Data_Path,"\SpikeInterface\SpikeInterface_Sorting_Phy_Results\Mountainsort 5");      
        SoterFolders(4) = "";
    elseif strcmp(Sorter,"SpykingCircus 2")
        SoterFolders(1) = "";
        SoterFolders(2) = "";
        SoterFolders(3) = "";
        SoterFolders(4) = strcat(app.Mainapp.Data.Info.Data_Path,"\SpikeInterface\SpikeInterface_Sorting_Phy_Results\SpykingCircus 2");
    end

    [Path,CurrentSorter,AmplitudeScalingFactorEditField,InfoText] = Spike_Module_Determine_Sorters_Available(app.Mainapp.Data,SoterFolders,0,0);
    ...
    if strcmp(app.SorterDropDown.Value,"Mountainsort 5") || strcmp(app.SorterDropDown.Value,"SpykingCircus 2")
        [app.Mainapp.Data,SaveFilter] = Spike_Module_Load_SpikeInterface_Sorter(app.Mainapp.Data,Path);
    end
    
    if strcmp(app.SorterDropDown.Value,"Kilosort")
