...
if ~strcmp(Sorter,"WaveClus 3")
    ...
    if strcmp(app.SorterDropDown.Value,"Mountainsort 5") || strcmp(app.SorterDropDown.Value,"SpykingCircus 2") || strcmp(app.SpikeSorterDropDown.Value,"Kilosort SpikeInterface")
        [app.Mainapp.Data,SaveFilter] = Spike_Module_Load_SpikeInterface_Sorter(app.Mainapp.Data,Path,CurrentSorter);
    end
    
    if strcmp(app.SorterDropDown.Value,"Kilosort External")
