function Extract_Events_Module_Load_and_Plot_Events_Intan(EventInfo,FilePaths,Figure,SelectedEventChannelNames,AllChannelNames,Data,RHDAllChannelData,DownsampleRate)
...
if isempty(EventPlotHandles)
    line(Figure,Time,InputChannelData,'LineWidth',1.5,'Color','b', 'Tag', 'Events');
else
    set(EventPlotHandles(1), 'XData', Time, 'YData', InputChannelData, 'Color', 'b', 'Tag', 'Events');
end