function [climsTF] = Event_Module_Time_Frequency_Main(EventRelatedData,Figure,SampleRate,DataChannelSelected,EventNrRange,TimearoundEvent,TF,Type,Plottype,WaveletType)
...
if strcmp(WaveletType,"Moorlet Wavelets")
    ...
    [climsTF] = Event_Module_Time_Frequency_Plot_WaveletTF (Figure,EventTime,TF.FreqRange,tf,frex,0,Plottype,Type,DataChannelSelected,EventNrRange);
elseif strcmp(WaveletType,"Filter Hilbert")
