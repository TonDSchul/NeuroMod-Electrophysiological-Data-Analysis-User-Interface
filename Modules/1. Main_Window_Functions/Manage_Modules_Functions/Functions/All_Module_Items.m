...
Module{1}.Items{4} = 'Instantaneous Frequency';
...
%% Event Data Module
Module{3}.Title = 'Event/TTL Data Module';
Module{3}.Function = 'RUN_Event_Data_Module';
Module{3}.Items{1} = 'Extract Events/TTL';
Module{3}.Items{2} = 'Import Events/TTL';
Module{3}.Items{3} = 'Preprocessing';
Module{3}.Items{4} = 'LFP Analysis';
Module{3}.Items{5} = 'Spike Analysis';
%% Spike Module
