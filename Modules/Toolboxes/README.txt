...
Original files from fieldtrip and the Open Ephys tools are unmodified. However there are functions calling and managing these toolboxes, which might not be compatible with future versions of these toolboxes. 
...
Spike repository from the cortex lab:
