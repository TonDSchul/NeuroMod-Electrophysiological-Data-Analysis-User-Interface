...
%AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Load_from_Kilosort","Extract_Events","Extract_Event_Related_Data","Event_Spike_Analysis","Continous_Spike_Analysis"];

AutorunConfig.FunctionOrder = ["Load_Data","Static_Power_Spectrum","Preprocess_Continous_Data","Internal_Spike_Detection","Preprocess_Continous_Data","Extract_Events","Extract_Event_Related_Data","Continous_Spike_Analysis","Event_Spike_Analysis","Event_Analysis_ERP","Event_Analysis_CSD","Event_Analysis_TimeFrequencyPower","Save_Data","Save_for_Kilosort"];
...
AutorunConfig.StaticPowerSpectrum.FrequencyRangeBPDepth = '0,200'; % Frequency Range shown in Power Spectrum analysis over depth. This only affects the plot and has no influence on the analysis. Input as char
...
%______________________________________________________________________________________________________
% Kilosort Plots
AutorunConfig.ContSpikeAnalysis.KilosortPlotType = ["Spike Map","Spike Amplitude Density Along Depth","Cumulative Spike Amplitude Density Along Depth","Average Waveforms Across Channel","Waveforms Templates","Template from Max Amplitude Channel"]; % "Spike Map","Spike Amplitude Density Along Depth","Cumulative Spike Amplitude Density Along Depth","Average Waveforms Across Channel","Waveforms from Raw Data","Waveforms Templates","Template from Max Amplitude Channel","Spike Triggered LFP"
% Internal Spike Plots
AutorunConfig.ContSpikeAnalysis.InternalSpikePlotType = ["Spike Map","Average Waveforms Across Channel","Spike Amplitude Density Along Depth","Cumulative Spike Amplitude Density Along Depth"]; % "Spike Map" OR "Average Waveforms Across Channel" OR "Spike Amplitude Density Along Depth" OR "Cumulative Spike Amplitude Density Along Depth" OR "Channel Waveforms" OR "Spike Triggered LFP"
...
AutorunConfig.InternalSpikeDetection.STDThreshold = '4'; % Number of standard deviations from mean to set threshold.
