    ...
    if Execute == 1
        if isfield(Data,'Spikes') && strcmp(Data.Info.SpikeType,"Kilosort")
            ...
            for i = 1:length(AutorunConfig.ContSpikeAnalysis.KilosortPlotType)
                ...
                for nunits = 1:TotalIterations
                    ...
                    [SpikeTimes,SpikePositions,SpikeAmps,CluterPositions,~,PlotInfo,ChannelSelectionforPlottingEditField,WaveformSelectionforPlottingEditField,UnitstoPlotEditField,SpikeRateNumBinsEditField,TimeWindowSpiketriggredLFPEditField] = Continous_Spikes_Prepare_Plots(Data,ChannelSelection,WaveformsToPlot,UnitsToPlot,[],"Kilosort",KilosortPlotType,NumBinsSpikeRate,TimeWindowSpiketriggredLFP,1,AutorunConfig.ContSpikeAnalysis.EventChannelToPlot);
                    
                    [Data] = Continous_Kilosort_Spikes_Manage_Analysis_Plots(Data,PlotInfo,SpikePositions,SpikeAmps,SpikeTimes,CluterPositions,UIAxes,KilosortPlotType.Value,TextArea,AutorunConfig.ContSpikeAnalysis.EventChannelToPlot,rgbMatrix,numCluster,CurrentClusterToPlot,UIAxes_3,UIAxes_2,AutorunConfig.twoORthree_D_Plotting);
                    ...
                    %% Plot
                    [Data] = Continous_Kilosort_Spikes_Manage_Analysis_Plots(Data,PlotInfo,SpikePositions,SpikeAmps,SpikeTimes,CluterPositions,UIAxes,AutorunConfig.ContSpikeAnalysis.KilosortPlotType(i),TextArea,AutorunConfig.ContSpikeAnalysis.EventChannelToPlot,rgbMatrix,numCluster,CurrentClusterToPlot,UIAxes_3,UIAxes_2,AutorunConfig.twoORthree_D_Plotting);
                    if ~strcmp(AutorunConfig.ContSpikeAnalysis.KilosortPlotType(i),"Spike Map")
                      [Data] = Continous_Kilosort_Spikes_Manage_Analysis_Plots(Data,PlotInfo,SpikePositions,SpikeAmps,SpikeTimes,CluterPositions,UIAxes,'SpikeRateBinSizeChange',TextArea,AutorunConfig.ContSpikeAnalysis.EventChannelToPlot,rgbMatrix,numCluster,CurrentClusterToPlot,UIAxes_2,UIAxes_3,AutorunConfig.twoORthree_D_Plotting);    
                    end
        ...
        elseif isfield(Data,'Spikes') && strcmp(Data.Info.SpikeType,"Internal")
            ...
            for i = 1:length(AutorunConfig.ContSpikeAnalysis.InternalSpikePlotType)
                ...
                Continous_Internal_Spikes_Manage_Analysis_Plots(AutorunConfig.ContSpikeAnalysis.InternalSpikePlotType(i),Data,SpikeTimes,SpikePositions,CluterPositions,SpikeAmps,PlotInfo,TextArea,ChannelPosition,UIAxes,UIAxes_2,UIAxes_3,rgbMatrix,AutorunConfig.twoORthree_D_Plotting)

                if ~strcmp(AutorunConfig.ContSpikeAnalysis.InternalSpikePlotType(i),"Spike Map")
                  Continous_Internal_Spikes_Manage_Analysis_Plots("SpikeRateBinSizeChange",Data,SpikeTimes,SpikePositions,CluterPositions,SpikeAmps,PlotInfo,TextArea,ChannelPosition,UIAxes,UIAxes_2,UIAxes_3,rgbMatrix,AutorunConfig.twoORthree_D_Plotting)
                end
