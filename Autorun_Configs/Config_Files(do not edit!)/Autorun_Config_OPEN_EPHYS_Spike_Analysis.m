...
%AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Static_Power_Spectrum","Preprocess_Continous_Data","Internal_Spike_Detection","Preprocess_Continous_Data","Extract_Events","Extract_Event_Related_Data","Continous_Spike_Analysis","Event_Spike_Analysis","Event_Analysis_ERP","Event_Analysis_CSD","Event_Analysis_TimeFrequencyPower","Save_Data"];
