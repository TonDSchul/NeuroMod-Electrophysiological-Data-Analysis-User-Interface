function [AutorunConfig] = Autorun_Config_Neuralynx_Spike_Analysis(DisplayOrder)
...
%______________________________________________________________________________________________________
AutorunConfig.ExtractEventDataModule.ChannelOfInterest = 'trigger'; % For Intan Recordings:'Analog Input' OR 'Digital Inputs' OR 'AUX Inputs' as char; For Open Ephys Recordings: name of node of interest as a char like "Record Node 101"
% For Neuralynx: EventChannelSelection not necessary!
...
% For Neuralny: EventSignalThreshold not necessary! 
