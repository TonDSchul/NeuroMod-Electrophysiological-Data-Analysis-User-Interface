function [AutorunConfig] = Autorun_Config_OPEN_EPHYS_Spike_Analysis(DisplayOrder)
...
%AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Load_from_Kilosort","Save_for_Kilosort"];
...
%______________________________________________________________________________________________________
AutorunConfig.ExtractEventDataModule.ChannelOfInterest = 'Record Node 113'; % For Intan Recordings:'Analog Input' OR 'Digital Inputs' OR 'AUX Inputs' as char; For Open Ephys Recordings: name of node of interest as a char like "Record Node 101"
% For Open Ephys: EventChannelSelection = line number of event dataframe
% loaded
...
% For Open Ephys: EventSignalThreshold = state of event dataframe
% loaded; which can be either 1 or 0 
