...
Furthermore, due to the neatless implementation of the NEO python library, you can further extract data recorded with Plexon (.plx), TDT (Tucker Davis TTank format), Blackrock and NeuroExplorer (.nex) recording systems.
