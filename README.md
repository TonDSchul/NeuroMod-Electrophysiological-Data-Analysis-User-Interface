...
<br>
NOTE: Currently only Kilosort 4 versions up to 4.0.8 are supported. Install legacy version py typing in your anaconda promt: conda activate kilsorot; python -m pip install "kilosort[gui]"==4.0.8
<br>
