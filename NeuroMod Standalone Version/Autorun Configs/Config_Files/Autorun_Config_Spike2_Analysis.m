...
AutorunConfig.ExtractRawRecording.RecordingsSystem = "Spike2"; % Recoring system with which recording was made. "Spike2"
AutorunConfig.ExtractRawRecording.FileType = ".smrx"; % .smrx for Spike2 recordings
%______________________________________________________________________________________________________
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Data Channel 1"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
