function [AutorunConfig] = Autorun_Config_TEMPLATE_Neuralynx_Analysis(DisplayOrder)
...
% What to execute
AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Static_Power_Spectrum","Event_Analysis_ERP","Event_Analysis_CSD"];
...
AutorunConfig.AutorunConfigName = "Neuralynx .ncs LFP and Spike Analysis";
...
AutorunConfig.ExtractRawRecording.NEOFormat = "NEO Neuralynx"; % Either "Auto Detected Recording System" to let NEO automatically detect the format. OR "NEO + Recordingsystemname" like "NEO Neuralynx" or "NEO Plexon" or "NEO New Open Ephys Format" OR "NEO Legacy Open Ephys Format"
...
AutorunConfig.SaveData.FieldTrip.EventChannelToUse = 'Event Ch 1'; % char with the name of the event channel you want to save event related data for like 'Event Ch 1'; empty if no events
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Event Ch 1"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
...
AutorunConfig.ContSpikeAnalysis.EventChannelToPlot = "Non"; %Non for no event plotting, empty for first automatically taking the first channel, otherwise eventName specified as char, like 'Event Ch 1' or 'ADC-01'
...
%______________________________________________________________________________________________________
AutorunConfig.PreproEventDataModule.EventChannelSelection = 'Event Ch 1'; % Event Channel for which you want to apply preprocessing
...
AutorunConfig.AnalyseEventDataModule.EventChannelSelection = 'Event Ch 0'; % 'Event Ch 1' , 'Event Ch 2' and so on are standard! (although the exact number is determined by your data, so double check in the GUI!)
