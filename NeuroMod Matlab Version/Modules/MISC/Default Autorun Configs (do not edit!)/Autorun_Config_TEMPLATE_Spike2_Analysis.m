...
AutorunConfig.SaveData.FieldTrip.EventChannelToUse = 'Data Channel 9'; % char with the name of the event channel you want to save event related data for like 'Data Channel 9'; empty if no events
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Data Channel 9"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
...
AutorunConfig.ContSpikeAnalysis.EventChannelToPlot = "Non"; %Non for no event plotting, empty for first automatically taking the first channel, otherwise eventName specified as char, like 'Data Channel 9' or 'ADC-01'
...
%______________________________________________________________________________________________________
AutorunConfig.PreproEventDataModule.EventChannelSelection = 'Data Channel 9'; % Event Channel for which you want to apply preprocessing
...
AutorunConfig.AutorunConfig.AnalyseEventDataModule.EventChannelSelection = 'Data Channel 9'; % 'Data Channel 9', the number depends on the amplifier channel event data represents that is selcted when data is extracted
