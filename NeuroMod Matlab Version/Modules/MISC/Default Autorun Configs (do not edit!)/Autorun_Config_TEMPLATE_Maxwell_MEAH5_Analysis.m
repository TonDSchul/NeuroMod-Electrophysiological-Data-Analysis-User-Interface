function [AutorunConfig] = Autorun_Config_TEMPLATE_Maxwell_MEAH5_Analysis(DisplayOrder)
...
% What to execute
AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Extract_Events","Event_Analysis_ERP"];
...
AutorunConfig.ChannelRange = 300:400; % Empty for all channel, otherwise Matlab expression; Note: Not active Channel! Put in incdicie of active channel. If Probe starts with active channel 5,6,7 and you specify channel 1,2 here, it means channel 5,6 are selected.
...
AutorunConfig.SaveData.FieldTrip.EventChannelToUse = 'Trigger Channel 1'; % char with the name of the event channel you want to save event related data for like 'Trigger Channel 1'; empty if no events
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Trigger Channel 1"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
...
AutorunConfig.ContSpikeAnalysis.EventChannelToPlot = "Non"; %Non for no event plotting, empty for first automatically taking the first channel, otherwise eventName specified as char, like 'Trigger Channel 1' or 'ADC-01'
...
AutorunConfig.ExtractEventDataModule.ChannelOfInterest = 'Bits Group'; % Options: 'Bits Group','Events Dataset'
AutorunConfig.ExtractEventDataModule.TriggerType = 'Trigger Onset'; % "Either Trigger Onset" OR "Trigger Offset"
...
%______________________________________________________________________________________________________
AutorunConfig.PreproEventDataModule.EventChannelSelection = 'Trigger Channel 1'; % Event Channel for which you want to apply preprocessing
...
AutorunConfig.AnalyseEventDataModule.EventChannelSelection = 'Trigger Channel 1'; % Options: 'TDT Trigger scalars:Evnt','TDT Trigger scalars:Tria','TDT Trigger epocs:Evnt','TDT Trigger epocs:Tria','TDT Trigger epocs:Brst','TDT Trigger epocs:Stro','TDT Trigger epocs:Tick' PLUS 'Ch 1' or Ch 2 depending in the input channel selection
