...
if ~isfile(PathVariableLocation)
    ...
    if ~isfile(Python_Conda_Environment_Path)
        ...
        disp("SpikeInterface Conda Python.exe loaded and found successfully!")
    end
end