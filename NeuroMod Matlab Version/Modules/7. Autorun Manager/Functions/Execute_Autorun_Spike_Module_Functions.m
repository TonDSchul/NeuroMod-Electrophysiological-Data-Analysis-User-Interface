...
if strcmp(FunctionOrder,'Load_from_SpikeSorting')
    ...
    if strcmp(AutorunConfig.LoadfromSpikeSorting.Sorter,"Mountainsort 5") 
        [Data,~] = Spike_Module_Load_SpikeInterface_Sorter(Data,SelectedFolder,"Mountainsort5",AutorunConfig.LoadfromSpikeSorting.SelectedCurationMethods,AutorunConfig.LoadfromSpikeSorting.SpikeChannelType,AutorunConfig.ParallelPool);
    end
    if strcmp(AutorunConfig.LoadfromSpikeSorting.Sorter,"SpyKING CIRCUS 2")
        [Data,~] = Spike_Module_Load_SpikeInterface_Sorter(Data,SelectedFolder,"SpykingCircus2",AutorunConfig.LoadfromSpikeSorting.SelectedCurationMethods,AutorunConfig.LoadfromSpikeSorting.SpikeChannelType,AutorunConfig.ParallelPool);
    end
    ...
    if strcmp(AutorunConfig.LoadfromSpikeSorting.Sorter,"Kilosort 4 external GUI") || strcmp(AutorunConfig.LoadfromSpikeSorting.Sorter,"Kilosort 3 external GUI")
        ...
        [Data,~] = Spike_Module_Load_Kilosort_Data(Data,"No",SelectedFolder,ScalingFactor,AutorunConfig.LoadfromSpikeSorting.Sorter,AutorunConfig.LoadfromSpikeSorting.DeleteMUA,AutorunConfig.LoadfromSpikeSorting.SpikeChannelType,AutorunConfig.ParallelPool);
    end
