...
if strcmp(Type,"MainDataPlot") || strcmp(Type,"All")
    ...
    PlotAppearance.MainWindow.Data.Plottype = "Individual Lines"; 
    ...
    PlotAppearance.MainWindow.Data.Color.GridTraceDataColor = [0,0,1]; % blue
    PlotAppearance.MainWindow.Data.Color.GridTraceEventColor = [0,0,1]; % blue
    ...
    PlotAppearance.MainWindow.Data.LineWidth.GridTraceData = 1.5;
    PlotAppearance.MainWindow.Data.LineWidth.GridTraceEvents = 1;
...
if strcmp(Type,"SpectrumPlot") || strcmp(Type,"All") 
    ...
    PlotAppearance.SpectrumWindow.PlotType = "Band Power Individual Channel ";
    PlotAppearance.SpectrumWindow.GridPlotType = "EventWindowLinesSpectrum";
    ...
    % LineWidth
    PlotAppearance.SpectrumWindow.Data.SpectrumLinwWidth = 1.5; 
    PlotAppearance.SpectrumWindow.Data.GridTraceDataWidth = 1.5; 
    PlotAppearance.SpectrumWindow.Data.GridTraceEventWidth = 1; 
    % Color
    ...
    PlotAppearance.SpectrumWindow.Data.GridTraceDataColor = [0,0.447058823529412,0.741176470588235]; %blue
    PlotAppearance.SpectrumWindow.Data.GridTraceEventColor = [0,0.447058823529412,0.741176470588235]; %blue
end
...
if strcmp(Type,"ERPPlot") || strcmp(Type,"All") 
    ...
    PlotAppearance.ERPWindow.Grid.GridDataLineWidth = 1.5; % 
    PlotAppearance.ERPWindow.Grid.GridEventLineWidth = 1; % 
    ...
    PlotAppearance.ERPWindow.Grid.GridDataColor = [0,0,1]; % blue
    PlotAppearance.ERPWindow.Grid.GridEventColor = [1,0,0]; % red
...
if strcmp(Type,"TFPlot") || strcmp(Type,"All") 
    PlotAppearance.TFWindow.PlotType = "OverFrequencies";
    PlotAppearance.TFWindow.GridPlotType = "EventWindowLines";
    ...
    PlotAppearance.TFWindow.PhaseDisplayThreshold = 0.5;
    % LineWidth
...
if strcmp(Type,"LiveSpectrogramPlot") || strcmp(Type,"All") 
    ...
    PlotAppearance.LiveSpectrogramWindow.PhaseDisplayThreshold = 0.5;
