function [AutorunConfig] = Autorun_Config_TDT_Analysis(DisplayOrder)
...
AutorunConfig.SaveData.FieldTrip.EventChannelToUse = 'TDT Trigger scalars:Evnt Ch 1'; % char with the name of the event channel you want to save event related data for like 'TDT Trigger scalars:Evnt Ch 1'; empty if no events
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "TDT Trigger scalars:Evnt Ch 1"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
...
AutorunConfig.ContSpikeAnalysis.EventChannelToPlot = "Non"; %Non for no event plotting, empty for first automatically taking the first channel, otherwise eventName specified as char, like 'TDT Trigger scalars:Evnt Ch 1' or 'ADC-01'
...
%______________________________________________________________________________________________________
AutorunConfig.PreproEventDataModule.EventChannelSelection = 'TDT Trigger scalars:Evnt Ch 1'; % Event Channel for which you want to apply preprocessing
...
AutorunConfig.AutorunConfig.AnalyseEventDataModule.EventChannelSelection = 'TDT Trigger scalars:Evnt Ch 1'; % 'Data Channel 9', the number depends on the amplifier channel event data represents that is selcted when data is extracted
