...
AutorunConfig.AnalyseEventDataModule.EventChannelSelection = 'Event Input Line 1'; % 'Event Ch 1' , 'Event Ch 2' and so on are standard! (although the exact number is determined by your data, so double check in the GUI!)
...
%______________________________________________________________________________________________________
AutorunConfig.Export.DatasetFormat = '.mat'; % .txt OR .xlsx OR .mat
