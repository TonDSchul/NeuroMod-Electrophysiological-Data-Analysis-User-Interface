...
AutorunConfig.FunctionOrder = ["Extract_Raw_Recording","Save_for_SpikeSorting"];
...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Event Input Line 1"; % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
...
AutorunConfig.LoadfromSpikeSorting.ScalingFactor = []; % ONLY FOR External KILOSORT GUI: char, This is the 'int32' scaling factor for conversion of kilosort amplitudes represented as integers back to mV. 
