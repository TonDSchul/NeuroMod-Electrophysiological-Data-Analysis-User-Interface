...
AutorunConfig.PreprocessCont.ArtefactRejetction.StimArtefactChannel = "Event Input Line 2"; % just an example! % Event channel which holds the time points of the stimulation. These are equal to the artefact time points
